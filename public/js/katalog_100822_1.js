...
function ZmenaMnozstviKatalogu(e) {
	var cil = e.target.id, puv = e.target.value, id = '', vysl = '';
	id = cil.substring(2);
...
dojo.addOnLoad(function(){
	...
	while (dojo.byId('ks' + i)) {
		...
		dojo.connect(dojo.byId('ks' + i), 'onchange', 'ZmenaMnozstviKatalogu');
		i++;
	}
